...
const experiences = [
  ...
  },
  {
    ...
    duration: "2026",
    description: "Developed a Kafka-integrated Spring Boot microservice for real-time transaction",
  },
  {
    role: "Web Developer Intern",
    company: "Genforge Studio",
    duration: "2026",
    description: "Built modern web user interfaces, API integrations, and code optimization",
  },
];
...
export default function Experience() {
  ...
  const thresholds = useMemo(() => experiences.map((_, i) => (i + 0.5) / experiences.length), [])
