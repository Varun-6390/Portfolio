...
const socials = [
  {Icon : FaXTwitter, label : "X" , href : "https://x.com/Artist_x_varun"},
  ...
  return(
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        style={{fontSize: "clamp(3rem,5vw,14rem)", letterSpacing:"0.02em", lineHeight:0.9,padding:"0.3vw", whiteSpace:"nowrap", textShadow:"0 2px 18px rgba(0,0,0,0.45)"}}>Varun Sharma</h1>
        ...
        <p>
          &copy; {new Date().getFullYear()} Varun Sharma. All rights reserved.
        </p>
      </motion.div>
    </footer>
  )
