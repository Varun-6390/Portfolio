...
import { SiNextdotjs, SiMysql, SiTailwindcss, SiPython, SiExpress , SiMongodb, SiJavascript, SiPostman} from "react-icons/si";
  ...
  return(
    <section id="skills" ref={sectionRef} className="h-1/2 w-full pb-8 flex flex-col items-center relative bg-black text-white overflow-hidden">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        ref={trackRef} className="flex gap-10 text-6xl text-[#1cd8d2]">
          {repeated.map((s,i) => (
