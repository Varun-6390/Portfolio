...
import { div, object, p } from "framer-motion/client";
import emailjs from "@emailjs/browser"
import { motion } from "framer-motion";
import Astra from "../assets/astrapro.png";
...
export default function Contacts(){
  ...
  return(
    ...
    <section id="contacts" className="w-full min-h-screen relative bg-black overflow-hidden text-white py-20 px-6 md:px-20 flex flex-col
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              ${errors.idea ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}></textarea>
